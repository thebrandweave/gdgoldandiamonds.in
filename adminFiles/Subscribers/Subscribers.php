                ...
                <div class="collapse navbar-collapse" id="sidebarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link active" href="../Subscribers/Subscribers.php">
                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">Subscribers</h1>
                            </div>
                            <!-- Actions -->
                        ...
                        <ul class="nav nav-tabs mt-4 overflow-x border-0">
                            <li class="nav-item ">
                                <a href="#" class="nav-link active">Subscribers</a>
                            </li>
                            <li class="nav-item">
                                <a href="./Add-Subscribers.php" class="nav-link font-regular">Add New</a>
                            </li>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <td>
                                    <a href='Delete_Subscribers.php?id=" .$row['subscriber_id']  . "' class='btn d-inline-flex btn-sm btn-danger border-base mx-1'>
                                        <span class='pe-2'>
